  ...
  },
  {
    ...
    render: (text, record) => (
      <Fragment>
        ...
        <a href="">订阅警报</a>
        <Divider type="vertical" />
        <Popconfirm placement="top" title={'确定删除吗？'} onConfirm={() => {}} okText="确定" cancelText="取消">
...
export default class TableList extends PureComponent {
  ...
  render() {
    ...
    const { selectedRows, modalVisible, showSelectList } = this.state;
          ...
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              ...
              {!this.state.showSelectList && (
                <Button onClick={() => this.handleShowSelectList()}>批量操作</Button>
              )}
              {this.state.showSelectList && (
                <span>
                <Button onClick={() => this.handleShowSelectList()}>
                  取消批量操作 
                </Button>
